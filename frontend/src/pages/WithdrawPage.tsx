      ...
      <div className="max-w-xl mx-auto">
        <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/50 p-8 text-center">
          ...
          <p className="text-slate-600 mb-6">
            ₹{formData.amount} has been withdrawn from account {formData.accountNumber}
          </p>
          <button
            onClick={() => {
              setSuccess(false);
            ...
            className="px-6 py-3 bg-gradient-to-r from-amber-500 to-orange-500 text-white font-medium rounded-xl shadow-lg shadow-amber-500/30"
          >
      ...
      <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/50 p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            ...
            className="w-full py-4 bg-gradient-to-r from-amber-500 to-orange-500 text-white font-semibold rounded-xl shadow-lg shadow-amber-500/30 hover:shadow-xl hover:shadow-amber-500/40 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
